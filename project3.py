...
#print("Welcome to the JAJ Investment Interface!")
...
if select_option == "Buy" and confirm:
    market_order_data = MarketOrderRequest(
                   symbol=(symbol),  #needs a variable
                   qty=qty,  #needs a variable
                   side=OrderSide.BUY,  #needs a variable
                   time_in_force=TimeInForce.DAY  #needs a variable
                   )
    ...
    st.balloons()
    st.write("Thank you for choosing the JAJ Investment Experience!")
elif select_option == "Sell" and confirm:
    market_order_data = MarketOrderRequest(
                   symbol=(symbol),  #needs a variable
                   qty=qty,  #needs a variable
                   side=OrderSide.SELL,  #needs a variable
                   time_in_force=TimeInForce.DAY  #needs a variable
                   )
    market_order = trading_client.submit_order(
    order_data=market_order_data
